...
names(jkpt_temp) <- c("jackpot_winners", "count")
jkpt_temp

ggplot(jkpt_temp, aes(fill=jackpot_winners, y=jackpot_winners, x=count)) +
   ggtitle("Jackput Winners") +
   theme(plot.title = element_text(hjust = 0.5)) +
   geom_bar(position='dodge', stat="identity") +
   xlab('Jackput Winners') +
   ylab('Count')
...
# view into wheather gambler should purchase for aaddiitonal monies the powerplay option
