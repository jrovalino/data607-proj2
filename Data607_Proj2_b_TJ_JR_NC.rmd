---
title: "Data607_Proj2_dataset#2 - Immigration Data"
...
df <- raw_data
df
#gets thw region (non-country) info to inspect into a data frame for removal so that we can be left with country data only. 
?filter
...
ggplot(df_2017_top5, aes(fill=Destination_Country, y=Destination_Country, x=a2017_perc)) +
  ggtitle("Top 5 Destination Country w/ Femail %") +
